...
public class IssueDAO {
    ...
    public List<Issue> getAll(){
        ...
        try(Connection con = DataSource.getConnection(); PreparedStatement ps = con.prepareStatement(SELECT_FROM_ISSUE_JOIN_USER_ON_USERID_EQUALS_ISSUE_USERID);
    ...
    public int create(Issue issue){
        ...
        try(Connection con = DataSource.getConnection(); PreparedStatement ps = con.prepareStatement(INSERT_INTO_ISSUE_VALUES)){
    ...
    public int update(Issue issue){
        ...
        try(Connection con = DataSource.getConnection(); PreparedStatement ps = con.prepareStatement(UPDATE_ISSUE_TITLE_AND_DESCRIPTION_BY_ISSUEID)){
    ...
    public int updateStatus(Issue issue){
        ...
        try(Connection con = DataSource.getConnection(); PreparedStatement ps = con.prepareStatement(UPDATE_ISSUE_STATUS_BY_ISSUEID)){
    ...
    public int delete(int id){
        ...
        try(Connection con = DataSource.getConnection(); PreparedStatement ps = con.prepareStatement(DELETE_FROM_ISSUE_BY_ISSUEID)){
            ps.setInt(1, id);
